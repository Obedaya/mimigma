...
from ..enigma.enigma import Enigma, get_rotor_settings_from_db
...
def get_encrypted_key():
    ...
    try:
        ...
        print(f"Machine type: {machine_type}, Rotors: {rotors}, Rotor positions: {rotor_positions}, Ring positions: {ring_positions}")
        
        enigma_machine = Enigma(machine_type, rotors, rotor_positions, ring_positions, reflector_type)
        encrypted_key = enigma_machine.encrypt_message(input.key.upper())
